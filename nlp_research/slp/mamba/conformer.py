...
class ConvolutionModule(nn.Module):
    ...
    def forward(
        ...
        dynchunktrain_config: DynChunkTrainConfig, optional
            ...
            <https://www.amazon.science/publications/dynamic-chunk-convolution-for-unified-streaming-and-non-streaming-conformer-asr>`_.
        ...
        if dynchunktrain_config is not None:
            ...
            out = F.conv1d(  # pylint: disable=not-callable
                out,
...
class ConformerEncoderLayer(nn.Module):
    ...
    def make_streaming_context(self, mha_left_context_size: int):
        ...
        ConformerEncoderLayerStreamingContext
        """
        return ConformerEncoderLayerStreamingContext(mha_left_context_size=mha_left_context_size)
...
class ConformerDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        pos_embs_tgt: torch.Tensor, torch.nn.Module, optional
            Module or tensor containing the target
            sequence positional embeddings for each attention layer.
        pos_embs_src: torch.Tensor, torch.nn.Module, optional
            Module or tensor containing the source
            sequence positional embeddings for each attention layer.
