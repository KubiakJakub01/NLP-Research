...
class ACTLossHead(nn.Module):
    ...
    def forward(
        ...
        **model_kwargs,
        ...
        Any, torch.Tensor, dict[str, torch.Tensor], dict[str, torch.Tensor] | None, torch.Tensor
    ]:
        # Model logits
        # B x SeqLen x D
        ...
        q_continue_loss = torch.tensor(0.0, device=outputs['q_continue_logits'].device)
